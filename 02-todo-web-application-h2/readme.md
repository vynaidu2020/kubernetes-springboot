...
Run com.vyn.web.app.h2.SpringBootFirstWebApplication as a Java Application.
...
- http://localhost:8080/login with vyn/dummy as credentials
- You can add, delete and update your todos
- Spring Security is used to secure the application
- `com.vyn.web.app.h2.security.SecurityConfiguration` contains the in memory security credential configuration.
